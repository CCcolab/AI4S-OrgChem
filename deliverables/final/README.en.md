...
| [`evidence_pack/`](evidence_pack/) | Cross-proposition primary evidence (one file per prop.) | Data |

Chinese originals (authoritative freeze text for this arm’s working language): `EXECUTIVE_SUMMARY.md`, `VERDICT_TABLE.md`, `FULL_REPORT.md`, `checklist.md`.

## Citation framing

Formal verdicts: this directory and each `deliverables/unit/Pn/VERDICT.md` only.
...
No use, copying, decompilation, or translation of the author’s programs; primary engine is existing WSL PySCF 2.14.0 only. See [`FULL_REPORT.en.md`](FULL_REPORT.en.md) §6.
