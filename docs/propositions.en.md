...
> **Project**: **AI-for-Science (AI4S) Agent** using state-of-the-art AI; third-party verification with WSL/PySCF (no changes to the existing environment) of claims in Zhongheng Yu’s *Questioning Fundamental Principles of Organic Chemistry* that challenge traditional organic structural theory.  
