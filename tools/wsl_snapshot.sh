...
if [ -x /home/cascade/micromamba/envs/ai4orgchem/bin/python ]; then
  /home/cascade/micromamba/envs/ai4orgchem/bin/python -V > "$INV/mamba_ai4orgchem_python_version.txt" 2>&1 || true
  if command -v micromamba >/dev/null 2>&1; then
    micromamba list -n ai4orgchem > "$INV/mamba_ai4orgchem_packages.txt" 2>&1 || true
  elif [ -x /home/cascade/micromamba/bin/micromamba ]; then
    /home/cascade/micromamba/bin/micromamba list -n ai4orgchem > "$INV/mamba_ai4orgchem_packages.txt" 2>&1 || true
  fi
  # tiny pointer file instead of copying env
  {
    echo "path: /home/cascade/micromamba/envs/ai4orgchem"
    du -sh /home/cascade/micromamba/envs/ai4orgchem 2>/dev/null
...
# directory map of home project-related paths
{
  ...
  echo
  du -sh /home/cascade/p3run /home/cascade/ai4orgchem_env /home/cascade/ai4orgchem-scratch \
    /home/cascade/micromamba/envs/ai4orgchem /home/cascade/micromamba/envs/ai4orgchem-nequip \
    /home/cascade/.local/lib/python3.12/site-packages/pyscf 2>/dev/null
  echo
...
rsync -a --delete \
  --exclude '__pycache__/' \
  --exclude '*.pyc' \
  /home/cascade/p3run/ "$HOME_SNAP/p3run/"

rsync -a --delete \
  --exclude '__pycache__/' \
  /home/cascade/ai4orgchem_env/ "$HOME_SNAP/ai4orgchem_env/" 2>/dev/null || \
  cp -a /home/cascade/ai4orgchem_env "$HOME_SNAP/" 2>/dev/null || true

rsync -a --delete \
  /home/cascade/ai4orgchem-scratch/ "$HOME_SNAP/ai4orgchem-scratch/" 2>/dev/null || \
  cp -a /home/cascade/ai4orgchem-scratch "$HOME_SNAP/" 2>/dev/null || true
